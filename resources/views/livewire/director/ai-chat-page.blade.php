            ...
            <x-ui.card class="flex-1 flex flex-col p-0 overflow-hidden">
                ...
                <div class="px-5 py-3 border-b border-border flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-muted">Analisis data berbasis AI</p>
                    </div>
                </div>
                ...
                <div class="p-4 border-t border-border bg-surface">
                    ...
                    <p class="text-sm text-muted mt-2 text-center">Dayta AI menganalisis data reporting. Hasil bersifat pendukung keputusan.</p>
                </div>
            </x-ui.card>
        </div>
    </div>

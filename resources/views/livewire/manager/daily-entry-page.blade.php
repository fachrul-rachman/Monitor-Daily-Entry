{{--
    Manager Daily Entry Page (content only, layout via components.layouts.app)
--}}
        ...
        <div x-show="tab === 'plan'">
            <x-ui.card>
                ...
                <p class="text-sm text-muted mb-4">
                    Rencana yang diisi di sini <span class="font-semibold">wajib terkait Big Rock</span> yang Anda pegang.
                </p>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            class="input"
                            placeholder="Contoh: Visit ke cabang A dan B"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Contoh: Visit cabang A dan B untuk cek implementasi SOP baru..."
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Contoh: Visit ini untuk mengukur dampak perubahan proses terhadap antrian pelanggan..."
            ...
            <x-ui.card>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            class="input min-h-[120px]"
                            placeholder="Contoh: Visit selesai, ada kendala cuaca di site B..."

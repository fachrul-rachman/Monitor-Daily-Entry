...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::view('/users', 'livewire.admin.users-page')->name('users');
    Route::view('/divisions', 'livewire.admin.divisions-page')->name('divisions');
    Route::view('/assignments', 'livewire.admin.assignments-page')->name('assignments');
    Route::view('/settings', 'livewire.admin.report-settings-page')->name('settings');
...
Route::prefix('hod')->name('hod.')->group(function () {
    ...
    Route::view('/daily-entry', 'livewire.hod.daily-entry-page')->name('daily-entry');
...
Route::prefix('manager')->name('manager.')->group(function () {
    ...
    Route::view('/daily-entry', 'livewire.manager.daily-entry-page')->name('daily-entry');
